...
public class Panier {
	...
	public String toString() {
		return "Panier [id=" + id + ", annee=" + annee + ", numero=" + numero + ", date_mvt=" + date_mvt + ", nom="
				...
				+ ", tel=" + tel + ", tel1=" + tel1 + ", tottht=" + tottht + ", tottva=" + tottva + ", totttc=" + totttc
	...
	public Panier(long id, int annee, int numero, Date date_mvt, String nom, String adresse, String sadresse,
			String ville, String codep, String tel, String tel1, double tottht, double tottva, double totttc,
			String modreg, String numcarte, List<Lpanier> lpaniers) {
		super();
		this.id = id;
		this.annee = annee;
		this.numero = numero;
